...
def train():
    ...
    t1 = time.time()
    # 获取汽车和非汽车的特征
    car_features = get_train_features(imgs=cars, cell_size=pix_per_cell,bin_count=bin_count,target_pic_size=(target_pic_size,target_pic_size),cell_perblock=cell_perblock)
    notcar_features = get_train_features(imgs=notcars, cell_size=pix_per_cell,bin_count=bin_count,target_pic_size=(target_pic_size,target_pic_size),cell_perblock=cell_perblock)
