...
class VideoCapture:
    ...
    def init_camera(self):
        ...
        self.logger.info('brightness',brightness)
        self.logger.info('width',width)
        self.logger.info('hight',hight)
        self.logger.info('rotation',rotation)
        self.logger.info('framerate',framerate)
        camera = PiCamera()
